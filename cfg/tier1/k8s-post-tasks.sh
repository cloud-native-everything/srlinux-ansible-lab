...
docker cp ./config-tier1-leaf1-5.js clab-srl02-leaf1:/home/admin/.
docker exec clab-srl02-leaf1 sr_cli --candidate-mode --commit-at-end -- load file /home/admin/config-tier1-leaf1-5.js
